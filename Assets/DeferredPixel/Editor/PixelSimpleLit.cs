...
namespace DeferredPixel.Editor
{
    internal class SimpleLitShader : BaseShaderGUI
    {
        private MaterialProperty IDProp { get; set; }
        // Properties
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            IDProp = FindProperty("_ID", properties, false);
        }
        ...
        public override void DrawSurfaceOptions(Material material)
        {
            ...
            // MaterialEditor.BeginProperty(IDProp);
            materialEditor.ShaderProperty(IDProp, "ID");
